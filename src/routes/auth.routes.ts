...
router.post(
    "/login",
    validation(authValidations.loginSchema),
...
router.post(
    "/rest-password",
    validation(authValidations.restPasswordEmailSchema),
    authController.restPasswordEmailHandler.bind(authController)
)

router.post(
    "/rest-password/:token",
    validation(authValidations.restPasswordSchema),
    authController.restPasswordHandler.bind(authController)
)
